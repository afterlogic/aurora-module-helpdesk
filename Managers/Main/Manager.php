							...
							))
							{
								...
								if (0 < \strlen($sEmail))
								{
									...
									if ($oUser)
									{
										...
										{
											$oThread = \CThread::createInstance('CThread', \Aurora\Modules\HelpDesk\Module::GetName());
											...
											if (is_array($aAttachments) && 0 < count($aAttachments))
											{
												foreach ($aAttachments as /* @var $oAttachment \Aurora\Modules\Mail\Classes\Attachment */ $oAttachment)
												{
													...
													if ($rData)
													{
														...
														$oAttachment = \CHelpdeskAttachment::createInstance('CHelpdeskAttachment', \Aurora\Modules\HelpDesk\Module::GetName());
